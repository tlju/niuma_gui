...
<h3>堡垒机二次认证流程</h3>
<p>当堡垒机配置了二次认证时，系统会自动引导完成认证流程：</p>
<ol>
<li><b>自动连接</b> — 系统启动时自动使用配置的堡垒机账号密码进行SSH连接</li>
<li><b>二次认证提示</b> — 连接成功后，堡垒机输出"2nd Password:"提示</li>
<li><b>输入动态口令</b> — 弹出二次认证对话框，输入6位数字动态口令（OTP）
    <ul>
    <li>输入满6位后自动提交</li>
...
<li><b>选择目标服务器</b> — 认证成功后，堡垒机显示可选服务器列表
    <ul>
    <li>列表格式：序号、IP地址、名称（说明）</li>
    <li>支持搜索过滤（按IP或名称）</li>
    <li>双击或选中后点击"连接"选择目标服务器</li>
    </ul>
</li>
<li><b>建立连接</b> — 选择服务器后，系统自动建立到目标服务器的连接</li>
</ol>

<h3>操作步骤 — 通过堡垒机连接资产</h3>
<ol>
<li>确保堡垒机已成功连接（状态栏显示绿色"已连接"）</li>
<li>如需二次认证，按上述流程完成动态口令验证和服务器选择</li>
